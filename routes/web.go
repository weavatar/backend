...
func Web() {
	...
	facades.Route().Prefix("captcha").Group(func(route route.Route) {
	...
	facades.Route().Prefix("user").Group(func(route route.Route) {
	...
	facades.Route().Prefix("system").Group(func(route route.Route) {
