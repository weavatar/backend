...
INSERT INTO "users_temp" ("id", "open_id", "union_id", "nickname", "is_admin", "real_name", "created_at", "updated_at", "deleted_at")
SELECT "id", "open_id", "union_id", "nickname", "is_admin", "real_name", "created_at", "updated_at", "deleted_at"
FROM "users";
...
UPDATE users SET avatar = 'https://weavatar.com/avatar/?d=mp' WHERE avatar IS NULL;
